...
export default auth((req) => {
  ...
  console.log("[MIDDLEWARE_DEBUG] Middleware called", { session, isLoggedIn, pathname });
  // Protected routes that require authentication
  const protectedRoutes = ["/settings"]; // Example, though settings page is deleted, we might re-add. For now, minimal.
