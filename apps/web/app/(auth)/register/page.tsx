              ...
              <div className="mt-6">
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 px-4 py-3 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 rounded-lg text-white transition-colors"
                  >
